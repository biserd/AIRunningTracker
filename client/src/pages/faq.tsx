            ...
            <section className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div>
                  ...
                  <p>
                    Eligible new accounts can start a 7-day trial with full access to Premium features: AI coaching, race predictions, training plans, and advanced analytics. A payment card is required, you pay $0 today, and you can cancel before the trial ends to avoid a charge. Premium is then $7.99/month or $79.99/year.
                  </p>
                </div>
              </div>
            </section>
