...
export function fixture() {
  ...
  for (const file of ["0001_preview.sql", "0003_reminders.sql", "0005_whatsapp.sql", "0006_whatsapp_oauth.sql", "0007_whatsapp_realtime.sql", "0008_whatsapp_context.sql", "0009_whatsapp_immediate.sql"])
    db.exec(
