  ...
  return <div className="launch-page">
    ...
    <main>
      ...
      <section className="launch-hero">
        <div><p className="launch-eyebrow"><span/> YOUR RUNNING. A REAL CONVERSATION.</p><h1>Your running coach.<br/><em>Ready when you are.</em></h1><p className="launch-lead">An AI running coach you can speak to, not just a dashboard to check. Talk through how you feel, ask a follow-up, and get a practical next step. Before your run, after it, or when life changes your plans.</p><a className="launch-button" href="#waitlist">Be first to know <ArrowRight size={20}/></a><p className="launch-note">Coming soon. One launch email. No payment needed.</p></div>
      ...
      <section className="launch-signup" id="waitlist"><p className="launch-eyebrow">YOUR NEXT CHAPTER STARTS HERE</p><h2>Get the starting signal.</h2><p>Be first to meet your new AI running coach. Voice conversations, practical guidance, and a plan that fits your life. We’ll email you when it officially launches.</p>
