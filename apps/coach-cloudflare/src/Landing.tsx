...
export function Landing() {
  ...
  return <div className="launch-page">
    ...
    <main>
      ...
      <section className="launch-editorial"><img src="/images/pre-run.webp" width="1100" height="733" loading="lazy" decoding="async" alt="AI-generated editorial image of a runner tying their shoes before a run"/><div><p className="launch-eyebrow">MORE RUNNING. LESS OVERTHINKING.</p><h2>The best plan is one<br/>you can actually run.</h2><p>Some days you have an hour. Some days you have twenty minutes. Get a little direction, make the call, and get out the door.</p><a className="launch-secondary" href="#waitlist">Find your next step <ArrowRight size={18}/></a></div></section>
