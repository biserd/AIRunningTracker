  ...
  return <div className="launch-page">
    ...
    <main>
      ...
      <section className="launch-hero">
        <div><p className="launch-eyebrow"><span/> YOUR AI RUNNING COACH. COMING SOON.</p><h1>Life changes.<br/><em>Your coach listens.</em></h1><p className="launch-lead">Talk through your next run. Adjust your week. Get a nudge when it matters. An AI coach ready for a conversation, whenever you are.</p><section className="launch-signup hero-signup" id="waitlist" aria-label="Join the waitlist"><p className="launch-note">One launch email. No payment. No commitment.</p>
