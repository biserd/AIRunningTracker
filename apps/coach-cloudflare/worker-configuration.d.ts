/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/coach-cloudflare/wrangler.jsonc apps/coach-cloudflare/worker-configuration.d.ts` (hash: ac664b6852d7b773c3309c9f189749ad)
...
interface __BaseEnv_Env {
	...
	WHATSAPP_GRANT_KEY: string;
	VOICE_LEASE: DurableObjectNamespace<import("./worker/index").VoiceLease>;
	WHATSAPP_DISPATCH: DurableObjectNamespace<import("./worker/index").WhatsAppDispatch>;
	BACKEND: Fetcher /* aitracker-main */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "VoiceLease" | "WhatsAppDispatch";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REMINDER_FROM" | "PUBLIC_ORIGIN" | "OPENAI_API_KEY" | "TWILIO_AUTH_TOKEN" | "TWILIO_ACCOUNT_SID" | "TWILIO_WHATSAPP_FROM" | "TWILIO_WHATSAPP_CONTENT_SID" | "WHATSAPP_GRANT_KEY">> {}
}
