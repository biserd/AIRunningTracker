/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/coach-cloudflare/wrangler.jsonc apps/coach-cloudflare/worker-configuration.d.ts` (hash: 07aa4b4f2c03f6573fdf623231901e2f)
