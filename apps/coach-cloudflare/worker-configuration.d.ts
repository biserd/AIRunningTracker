/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/coach-cloudflare/wrangler.jsonc apps/coach-cloudflare/worker-configuration.d.ts` (hash: c1bd0911eb9581e2ff1c54f49098735c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "REMINDER_FROM" | "PUBLIC_ORIGIN" | "OPENAI_API_KEY" | "TWILIO_AUTH_TOKEN" | "TWILIO_ACCOUNT_SID" | "TWILIO_WHATSAPP_FROM" | "TWILIO_WHATSAPP_CONTENT_SID">> {}
}
