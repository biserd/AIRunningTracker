/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/coach-cloudflare/wrangler.jsonc apps/coach-cloudflare/worker-configuration.d.ts` (hash: bbd065f1b7b264775f151fc3b6006af2)
