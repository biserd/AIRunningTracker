/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api-cloudflare/container/wrangler.production.jsonc --env-interface=ProductionEnv apps/api-cloudflare/container/production-configuration.d.ts` (hash: 6e01f48bb81d5b0556366bf8b581bd33)
...
interface __BaseEnv_ProductionEnv {
	...
	APPLE_SUBSCRIPTIONS_ALLOW_SANDBOX: "true";
	CLOUDFLARE_EMAIL_ACCOUNT_ID: "73d71a2bef58f7469ecb48e2b8e84c0e";
	EMAIL_FROM: "RunAnalytics <hello@aitracker.run>";
	APP_ROLE: "jobs";
	HERMES_MCP_CLIENT_ID: "ra_mcp_client_L0o4CkpSbZeZ8xlI4MyQeNXh";
	TELEGRAM_BOT_USERNAME: "hermes_3njyz3nxuousjmh2_bot";
	ALLOWED_PRICE_IDS: "price_1SbtcfRwvWaTf8xfSEO4iKnc,price_1SbtcfRwvWaTf8xfwcVnrRf8";
	D1_TRANSPORT_SECRET: string;
	JWT_SIGNING_SECRET: string;
	EMAIL_UNSUBSCRIBE_SIGNING_SECRET_V2: string;
	MARKETING_LINK_SIGNING_SECRET: string;
	MCP_TOKEN_HASH_SECRET: string;
	CHANNEL_IDENTITY_HASH_SECRET: string;
	COACH_BINDING_CALLBACK_SECRET: string;
	COACH_AGENT_WEBHOOK_SIGNING_SECRET_V2: string;
	COACH_AGENT_WEBHOOK_URL: string;
	...
	WEB: DurableObjectNamespace<import("./production").RunAnalyticsProduction>;
	COACH_NOTIFICATIONS: Service /* entrypoint CoachNotifications from aitracker-coach-preview */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./production");
		durableNamespaces: "RunAnalyticsProduction";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APPLE_SUBSCRIPTIONS_ALLOW_SANDBOX" | "CLOUDFLARE_EMAIL_ACCOUNT_ID" | "EMAIL_FROM" | "APP_ROLE" | "HERMES_MCP_CLIENT_ID" | "TELEGRAM_BOT_USERNAME" | "ALLOWED_PRICE_IDS" | "D1_TRANSPORT_SECRET" | "JWT_SIGNING_SECRET" | "EMAIL_UNSUBSCRIBE_SIGNING_SECRET_V2" | "MARKETING_LINK_SIGNING_SECRET" | "MCP_TOKEN_HASH_SECRET" | "CHANNEL_IDENTITY_HASH_SECRET" | "COACH_BINDING_CALLBACK_SECRET" | "COACH_AGENT_WEBHOOK_SIGNING_SECRET_V2" | "COACH_AGENT_WEBHOOK_URL" | "OPENAI_API_KEY" | "CLOUDFLARE_EMAIL_API_TOKEN" | "STRAVA_CLIENT_SECRET" | "VITE_STRAVA_CLIENT_ID" | "STRIPE_SECRET_KEY" | "VITE_STRIPE_PUBLIC_KEY" | "STRAVA_SUBSCRIPTION_ID">> {}
}
