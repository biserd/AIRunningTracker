/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api-cloudflare/container/wrangler.production.jsonc --env-interface=ProductionEnv apps/api-cloudflare/container/production-configuration.d.ts` (hash: c4637b92a8d2a4fb4a27e6e1aafb5a60)
