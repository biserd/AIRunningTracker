/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=container/wrangler.production.jsonc --env-interface=ProductionEnv container/production-configuration.d.ts` (hash: 90ef0b8a4c30ce4befb4eb479dcf0dde)
