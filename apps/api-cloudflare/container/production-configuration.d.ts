/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=container/wrangler.production.jsonc --env-interface=ProductionEnv container/production-configuration.d.ts` (hash: 8835d83c3ef517b027064edfe20b8e38)
