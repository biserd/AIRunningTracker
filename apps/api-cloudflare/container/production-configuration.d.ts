/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.production.jsonc --env-interface=ProductionEnv production-configuration.d.ts` (hash: 05ff2438abc9b8c6494a4ee6fc21d357)
