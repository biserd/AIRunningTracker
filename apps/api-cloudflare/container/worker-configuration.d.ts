/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=container/wrangler.jsonc container/worker-configuration.d.ts` (hash: fe035b6debb7af18e0490776fa6699fe)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATABASE_URL" | "JWT_SIGNING_SECRET" | "CUTOVER_EMAIL_UNSUBSCRIBE_SIGNING_SECRET_V2" | "CUTOVER_STRIPE_SECRET_KEY" | "CUTOVER_RESEND_API_KEY" | "CUTOVER_OPENAI_API_KEY" | "CUTOVER_VITE_STRAVA_CLIENT_ID" | "CUTOVER_STRAVA_CLIENT_SECRET">> {}
}
