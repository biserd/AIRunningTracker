/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api-cloudflare/container/wrangler.jsonc apps/api-cloudflare/container/worker-configuration.d.ts` (hash: 7d51d1c6b105069ba8f2a5707fb8b6f8)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATABASE_URL" | "JWT_SIGNING_SECRET" | "CUTOVER_EMAIL_UNSUBSCRIBE_SIGNING_SECRET_V2" | "CUTOVER_STRIPE_SECRET_KEY" | "CUTOVER_OPENAI_API_KEY" | "CUTOVER_VITE_STRAVA_CLIENT_ID" | "CUTOVER_STRAVA_CLIENT_SECRET">> {}
}
