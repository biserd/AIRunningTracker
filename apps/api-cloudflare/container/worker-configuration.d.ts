/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=container/wrangler.jsonc container/worker-configuration.d.ts` (hash: bb9c8baed1f7c28e0e2cdbf2b9ac53d5)
...
interface __BaseEnv_Env {
	...
	CUTOVER_EMAIL_UNSUBSCRIBE_SIGNING_SECRET_V2: string;
	CUTOVER_STRIPE_SECRET_KEY: string;
	CUTOVER_RESEND_API_KEY: string;
	CUTOVER_RESEND_WEBHOOK_SECRET: string;
	CUTOVER_OPENAI_API_KEY: string;
	CUTOVER_VITE_STRAVA_CLIENT_ID: string;
	CUTOVER_STRAVA_CLIENT_SECRET: string;
	WEB: DurableObjectNamespace<import("./index").RunAnalyticsWeb>;
	PRODUCTION: Fetcher /* aitracker-main */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "RunAnalyticsWeb";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "DATABASE_URL" | "JWT_SIGNING_SECRET" | "CUTOVER_EMAIL_UNSUBSCRIBE_SIGNING_SECRET_V2" | "CUTOVER_STRIPE_SECRET_KEY" | "CUTOVER_RESEND_API_KEY" | "CUTOVER_RESEND_WEBHOOK_SECRET" | "CUTOVER_OPENAI_API_KEY" | "CUTOVER_VITE_STRAVA_CLIENT_ID" | "CUTOVER_STRAVA_CLIENT_SECRET">> {}
}
